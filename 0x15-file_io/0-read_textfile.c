...
/**
  * read_textfile - reads @letters number of characters from @filename file
  * and prints it to stdout.
  * @filename: pointer to address of the file,
  * @letters: number of characters to be read and printed.
  * Return: the number of characters that have actually been read and printed,
  * or 0 otherwise.
  */
